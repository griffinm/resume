  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="p-8">
              <div className="mb-4 p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg inline-block">
                <svg
          ...
          >
            <div className="p-8">
              <div className="mb-4 p-3 bg-green-100 dark:bg-green-900/30 rounded-lg inline-block">
                <svg
